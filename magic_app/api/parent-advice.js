// api/parent-advice.js — Советы психолога (версия от 3 мая 2026)
export default async function handler(req, res) {
    ...
    try {
        ...
        let ageContext = '';
        if (age <= 7) {
            ageContext = `Ребёнок — дошкольник (${age} лет). Используй рекомендации для маленьких детей: игры, сказки, телесный контакт с родителем.`;
        } else {
