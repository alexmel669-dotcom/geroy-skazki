  ...
  guessBtn.onclick = async () => {
    ...
    try {
      const res = await fetch('/api/generate', {
        ...
        body: JSON.stringify({
          message: 'Посмотри на рисунок и скажи ОДНИМ словом что нарисовано. Только одно слово по-русски. Не говори "мурр" или "не знаю". Если не можешь определить — скажи "непонятно".',
